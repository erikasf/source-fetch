Sourcefetch = require '../lib/sourcefetch'
  ...
  describe "when the sourcefetch:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        sourcefetchElement = workspaceElement.querySelector('.sourcefetch')
        expect(sourcefetchElement).toExist()

        sourcefetchPanel = atom.workspace.panelForItem(sourcefetchElement)
